...
# data
MODELS = ('GFDL', 'MPI', 'MRI', 'IPSL', 'UKESM', 'OBSERVATION')
VARIABLES = ('pr', 'tas', 'tasmax', 'tasmin')
SSPS = ('ssp126','ssp370', 'ssp585', 'W5E5v1.0')
...
class IsimipVisualizer(Tk):
    ...
    def _create_window_title(self):
        titleLabel = Label(self, text="ISIMIP Visualizer", font=FONT_LARGE, bg=DARK_BURGANDY,fg='white')
    ...
    def create_visual(self):
        data = extract_per_year(self.model, self.variable, self.ssp, 0)
